...
while true; do
    ...
    echo -e "${CYAN}╠═══════════════════════════════════════════════════════════╣${NC}"
    echo -e "${CYAN}║${NC} 1.  Dam bao cac dependency da duoc cai dat               ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} 2. Them domain moi va vung DNS                           ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} 3.  Them hosting cho domain                              ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} 4.  Liet ke cac domain dang hoat dong                    ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} 5.  Go bo may chu web                                    ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} 6.  Tat tuong lua                                        ${CYAN}║${NC}"
    echo -e "${CYAN}║${NC} 7.  Thoát                                                ${CYAN}║${NC}"
    echo -e "${CYAN}╚═══════════════════════════════════════════════════════════╝${NC}"
